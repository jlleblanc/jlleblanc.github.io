      ...
      <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-slate-200 font-sans selection:bg-lime-500/30 transition-colors duration-300">
        ...
        <nav className="fixed w-full z-50 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="hidden md:flex gap-8 text-sm font-medium text-slate-600 dark:text-slate-400">
              ...
              <a href="#growth" className="hover:text-lime-700 dark:hover:text-white transition-colors">Roadmap</a>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 p-6 flex flex-col gap-4">
              ...
              <a href="#growth" className="text-slate-600 dark:text-slate-300" onClick={() => setIsMenuOpen(false)}>Roadmap</a>
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-4">
              ...
              <div className="flex flex-col md:text-left">
                <span className="text-2xl font-bold text-slate-900 dark:text-white">Joe LeBlanc</span>
                <span className="text-lime-700 dark:text-lime-500 text-sm">Fractional Founding Engineer</span>
              </div>
            </div>
        ...
        <section id="growth" className="py-20 bg-gray-900 text-white relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-20 pointer-events-none">
            <div className="absolute -top-24 -left-24 w-96 h-96 bg-lime-500 rounded-full blur-3xl"></div>
            <div className="absolute top-1/2 right-0 w-64 h-64 bg-teal-500 rounded-full blur-3xl"></div>
          </div>

          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Roadmap<br /></h2>
                <h3 className="text-lg text-lime-400 font-medium mb-4">Your roadmap from MVP to Series A and beyond.</h3>
                <div className="space-y-8">
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 h-12 w-12 rounded bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
                      <Star className="text-lime-400 w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="text-xl font-bold mb-2">Differentiation</h4>
                      <p className="text-gray-400 leading-relaxed">Own your IP. Identify which parts of your code are Commodity (payments, login) vs. Proprietary (algorithms, data).</p>
                    </div>
                  </div>

                  <div className="flex gap-4">
                    <div className="flex-shrink-0 h-12 w-12 rounded bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
                      <DollarSignIcon className="text-lime-400 w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="text-xl font-bold mb-2">Cost Model</h4>
                      <p className="text-gray-400 leading-relaxed">Detail exact infrastructure costs (e.g., API calls, LLM tokens) per user. Prove to investors you&apos;re building a profitable business.</p>
                    </div>
                  </div>

                  <div className="flex gap-4">
                    <div className="flex-shrink-0 h-12 w-12 rounded bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
                      <ChartArea className="text-lime-400 w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="text-xl font-bold mb-2">Scale</h4>
                      <p className="text-gray-400 leading-relaxed">Honestly identify when the system will break (e.g., at 2k users) and what it will take to scale up.</p>
                    </div>
                  </div>

                  <div className="flex gap-4">
                    <div className="flex-shrink-0 h-12 w-12 rounded bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
                      <User2 className="text-lime-400 w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="text-xl font-bold mb-2">Team</h4>
                      <p className="text-gray-400 leading-relaxed">Build a real hiring plan. Don&apos;t just &quot;hire the top 1%.&quot; Tie specific feature goals to specific hires (e.g., &quot;React Native Dev for Mobile App in Q3&quot;).</p>
                    </div>
                  </div>
                </div>
              </div>

              <div className="bg-gray-800 rounded-lg border border-gray-700 shadow-2xl relative overflow-hidden group h-full flex flex-col">
                <div className="flex items-center gap-2 p-6 border-b border-gray-700 relative z-20 bg-gray-800/50 backdrop-blur w-full">
                  <div className="w-3 h-3 rounded-full bg-red-500"></div>
                  <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                  <div className="w-3 h-3 rounded-full bg-green-500"></div>
                  <span className="text-gray-500 font-mono text-sm ml-2">growth_line.map</span>
                </div>

                <div className="relative w-full flex-1 flex items-center justify-center z-10 p-4">
                  {/* Subway Map SVG */}
                  <svg className="w-full h-full max-h-[400px]" viewBox="0 0 480 300" preserveAspectRatio="xMidYMid meet">
                    <defs>
                      <linearGradient id="lineGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#3b82f6" /> {/* Blue */}
                        <stop offset="33%" stopColor="#10b981" /> {/* Green */}
                        <stop offset="66%" stopColor="#a855f7" /> {/* Purple */}
                        <stop offset="100%" stopColor="#f59e0b" /> {/* Yellow */}
                      </linearGradient>
                      <filter id="glow">
                    ...
                    <path
                      d="M 40 250
                                       C 75 250, 75 200, 100 200
                                       L 130 200
                                       C 155 200, 155 100, 175 100
                                       L 200 100
                                       C 230 100, 230 150, 250 150
                                       L 280 150
                                       C 305 150, 305 50, 325 50
                                       L 375 50"
                      fill="none"
                    ...
                    {/* Station: Start (MVP) */}
                    <circle cx="40" cy="250" r="10" fill="#1f2937" stroke="#ffffffff" strokeWidth="4" />
                    <text x="40" y="280" fill="#9ca3af" fontSize="12" fontWeight="bold" textAnchor="middle" fontFamily="monospace">MVP</text>

                    {/* Station 1: IP */}
                    <g>
                      <circle cx="115" cy="200" r="10" fill="#1f2937" stroke="#ffffffff" strokeWidth="4" />
                      <rect x="80" y="160" width="70" height="24" rx="6" fill="#1f2937" stroke="#3b82f6" strokeWidth="2" />
                      <text x="115" y="177" fill="#fff" fontSize="12" textAnchor="middle" fontWeight="bold">IP</text>
                    </g>

                    {/* Station 2: Money */}
                    <g>
                      <circle cx="187" cy="100" r="10" fill="#1f2937" stroke="#ffffffff" strokeWidth="4" />
                      <rect x="152" y="60" width="70" height="24" rx="6" fill="#1f2937" stroke="#10b981" strokeWidth="2" />
                      <text x="187" y="77" fill="#fff" fontSize="12" textAnchor="middle" fontWeight="bold">Money</text>
                    </g>

                    {/* Station 3: Scale */}
                    <g>
                      <circle cx="265" cy="150" r="10" fill="#1f2937" stroke="#ffffffff" strokeWidth="4" />
                      <rect x="230" y="110" width="70" height="24" rx="6" fill="#1f2937" stroke="#a855f7" strokeWidth="2" />
                      <text x="265" y="127" fill="#fff" fontSize="12" textAnchor="middle" fontWeight="bold">Scale</text>
                    </g>

                    {/* Station 4: Team */}
                    <g>
                      <circle cx="337" cy="50" r="10" fill="#1f2937" stroke="#ffffffff" strokeWidth="4" />
                      <rect x="302" y="10" width="70" height="24" rx="6" fill="#1f2937" stroke="#f59e0b" strokeWidth="2" />
                      <text x="337" y="27" fill="#fff" fontSize="12" textAnchor="middle" fontWeight="bold">Team</text>
                    </g>

                    {/* End Point: Series A */}
                    <circle cx="375" cy="50" r="0" fill="#1f2937" stroke="#f59e0b" strokeWidth="0" />
                    <text x="385" y="55" fill="#f59e0b" fontSize="14" fontWeight="bold" textAnchor="start" fontFamily="monospace">Series A</text>
